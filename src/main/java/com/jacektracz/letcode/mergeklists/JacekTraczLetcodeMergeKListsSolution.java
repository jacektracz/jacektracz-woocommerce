...
class JacekTraczLetcodeMergeKListsSolution {
    ...
    public boolean DBG_MODE = false;
    public int DBG_LEVEL = 4;
    public boolean HANDLE_TAILS = true;
    ...
    private void mergeTwoRoots(
        ...
        while( true )                
        {
            ...
            if( l_handled_0_current == null   && HANDLE_TAILS)
            {
            	...
            	if(DBG_MODE) dbgList(l_handled_1_current, sFunMN + lv +  "[nodes:" + ii + "]" + "l_handled_1_current-aded-as-tail" );
            	if(DBG_MODE) dbgList(l_out_created_root_current[1], sFunMN + lv +  "[nodes:" + ii + "]" + "l_out_created_root_current-filled-with-tail" );
            ...
            if( l_handled_1_current == null   && HANDLE_TAILS)
            {
            	...
            	if(DBG_MODE) dbgList(l_handled_0_current, sFunMN + lv +  "[nodes:" + ii + "]" + "l_handled_0_current-aded-as-tail" );
            	if(DBG_MODE) dbgList(l_out_created_root_current[1], sFunMN + lv +  "[nodes:" + ii + "]" + "l_out_created_root_current-filled-with-tail" );
    ...
    private int dbgListShort ( 
            ...
            if(DBG_MODE) dbgInfoLvl0(sFun + " " + sList);
