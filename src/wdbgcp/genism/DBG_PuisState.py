...
class DBG_PuisState(DBG_AdapterBase):
        def __init__(self,spar):
                ...
                #self.m_child_item = DBG_ApstTable("Parent::DBG_PuisState")
                self.m_fields = DBG_FieldsMapper("DBG_PuisState"
                                         , self)
        ...
        def prepare_object(self):
                try:
                        ...
                        self.xx_exception("DBG_PuisState::prepare_object::exc::")
                                        
        def prepare_object_internal(self, pparent):
                self.xx_dbg("DBG_PuisState::prepare_object_internal::")
