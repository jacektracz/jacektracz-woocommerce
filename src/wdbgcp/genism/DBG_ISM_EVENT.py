...
class DBG_ISM_EVENT(DBG_AdapterBase):
        def __init__(self,spar):
                ...
                self.xx_set_class_name ( "ISM_EVENT" )
                self.xx_set_full_class_name ( "iastora!ISM_EVENT" )
                #self.m_child_item = DBG_ApstTable("Parent::DBG_ISM_EVENT")
                self.m_fields = DBG_FieldsMapper("DBG_ISM_EVENT"
                                         , self)
