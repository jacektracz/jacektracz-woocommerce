...
class LKD_CreateMdFilesFromProjectsParent:
        ...
        def __init__(self):                                
                self.xx_dbg("LKD_CreateMdFilesFromProjectsParent::__init__::in::")
        ...
        def get_folder_cat_items(self , tt):                
                ...
                for lkd_cats_group_item in data_items:
                        ...
                        src_articles_parent_path = lkd_cats_group_item.get_src_root_dir_path()
                        parent_cat_id = lkd_cats_group_item.get_src_root_cat_id()

                        self.xx_dbg("src_root::" + src_articles_parent_path)

                        one_def_folder_cat_items = self.read_directory_subdirs(
                                src_articles_parent_path,
                                parent_cat_id + 1)
                        folder_cat_items.extend(one_def_folder_cat_items)                        
