...
class DBG_FieldsBase:
        ...
        def get_parent_tabs(self, parent,ii_tabs):
                tabsp = ""                                        
                try:
                        self.xx_dbg("DBG_FieldsBase::get_parent_tabs::in::")
                        
                        if(parent != None):
                                if(hasattr(parent, 'xx_gett')):
                                        tabsp = parent.xx_gett(ii_tabs)
                        return tabsp                                                                                
                        self.xx_dbg("DBG_FieldsBase::get_parent_tabs::out::")
                        
                except:                        
                        self.xx_exception("DBG_FieldsBase::get_parent_tabs:exc::")                        
                        return tabsp
