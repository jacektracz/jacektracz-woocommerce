...
class DBG_BrkChipset(DBG_BreakpBase):
        ...
        def get_dispatch(self,tt):
                if(tt == "chipset_ini_path"):
                        return self.get_methods_ini_path()
                return None
        
        def get_methods_ini_path(self):
                self.xx_dbg("DBG_BreakpRaidport::get_methods_ini_path::method_in::")
                pp = [
                        "ScsiPortInitialize"
                ...
                self.xx_dbg("DBG_BreakpRaidport::get_methods_ini_path::method_out::")
                return pp
