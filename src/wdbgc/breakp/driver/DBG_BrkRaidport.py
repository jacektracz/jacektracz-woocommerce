...
class DBG_BrkRaidport(DBG_BreakpBase):
        ...
        def get_dispatch(self,tt):
                if(tt == "crash_nv_hiber"):
                        return self.get_methods_crash_nv_hiber()
                
                if(tt == "enum_entry"):
                        return self.get_methods_enum_entry()
        ...
        def get_methods_crash_nv_hiber(self):
                self.xx_dbg("DBG_BreakpRaidport::get_methods_enum_entry::method_in::")
                pp=[
                    "NvCrashDmp::writeExtentLog"
                    ,"NvCrashDmp::initForRead"
                    ]
                self.xx_dbg("DBG_BreakpRaidport::get_methods_enum_entry::method_out::")
                return pp
        
        def get_methods_enum_entry(self):
                self.xx_dbg("DBG_BreakpRaidport::get_methods_enum_entry::method_in::")
                pp=[
                    "IntervalTimer::addEvent"
                    ,"AtaDevice::AtaDevice"
                    ]
                self.xx_dbg("DBG_BreakpRaidport::get_methods_enum_entry::method_out::")
                return pp
