...
class DBG_MemberDiskReq(DBG_AdapterBase):
        ...
        def init_object_fields(self):
                self.xx_dbg("DBG_MemberDiskReq::init_object_fields::in::")                                
                #self.m_fields.add_fields_asstr_ints([])                                                
                self.xx_dbg("DBG_MemberDiskReq::init_object_fields::m_out::")
        ...
        def xx_obj_valid(self):
                self.xx_dbg("DBG_MemberDiskReq::xx_obj_valid::m_in::")
                i_valid = self.xx_is_object()
                self.xx_dbg("DBG_MemberDiskReq::xx_obj_valid::m_out::" + str(i_valid))
                return i_valid
