...
from .. appsrc.ismcfg.DBG_MemberDiskReqPool import *
...
class DBG_RaidIsm(DBG_AdapterBase):
    ...
    def __init__(self,spar):                
        ...
        self.freeMdrs = DBG_MemberDiskReqPool("DBG_RaidIsm",self)
        self.freeMdrsSaved = DBG_MemberDiskReqPool("DBG_RaidIsm",self)
        self.raiddevs = DBG_raidDev_PyArray("Parent::DBG_RaidIsm",self)
    ...
    def prepare_object_internal(self, pparent):
        ...
        if(self.xx_obj_valid() == 1):
            ...
            self.freeMdrs.set_addr_arr(self,"freeMdrs")
            self.freeMdrs.prepare_object()
            
            self.freeMdrsSaved.set_addr_arr(self,"freeMdrsSaved")
            self.freeMdrsSaved.prepare_object()
    ...
    def print_object_internal(self,pparent,sdbg=""):
        ...
        if(self.xx_obj_valid() == 1):
            ...
            self.freeMdrs.print_object()
            self.freeMdrsSaved.print_object()
